...
The built-in query builder can be used to parameterize SQL queries to avoid SQL injection.

Multiple parameters can be added using to the statement using the "?" placeholder. If the number of parameters does not match the number of "?", an error will be thrown.
